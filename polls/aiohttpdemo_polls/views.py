...
"""Templates are a very convenient way for web page writing. 
If we return a dict with page content,
 the aiohttp_jinja2.template decorator processes 
 the dict using the jinja2 template renderer."""
...
async def vote(request):
    async with request.app["db"].acquire() as conn:
        ...
        try:
            ...
            raise web.HTTPBadRequest(text="You have not specified choice value")
        try:
