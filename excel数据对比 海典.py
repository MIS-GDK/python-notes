...
wb = load_workbook(r"C:\Users\Administrator\Desktop\润芝堂.xlsx")
# 1、获取sheet名称
...
for row in sheet.iter_rows(min_row=2):
    ...
    for i in [
        ...
        if isinstance(i, str) and i.isdigit():
            ...
            row_data1.append(i)
    all_data1[row_data1[1]] = row_data1
...
for row in sheet2.iter_rows(min_row=2):
    ...
    for i in [
        ...
        if isinstance(i, str) and i.isdigit():
            ...
            row_data2.append(i)
    all_data2[row_data2[1]] = row_data2
...
wb2.save(r"C:\Users\Administrator\Desktop\润芝堂数据差异1.xlsx")
